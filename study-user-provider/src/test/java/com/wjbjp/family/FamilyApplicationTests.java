...
import com.user.provider.UserProviderApplication;
...
//    }
    ...
    @Test
    public void  textMap(){
        Map<String, Object> map=TypeChange.jsonStrToJavaBean("{id:1}", Map.class);

        List<HashMap<String,Object>> obj= mhs.execByMap("select * from fa_user where id=#{map.id}",map);
        System.out.println(TypeChange.objToString(obj));
    }
}
